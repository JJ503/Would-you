...
class applyTeamFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var preView = inflater.inflate(R.layout.fragment_apply_team, container, false)
        ...
        while (cursor1.moveToNext()) {
            ...
            cursor2 = sqlitedb.rawQuery("SELECT * FROM team WHERE t_num = " + team_num + ";", null) //쿼리2
        ...
        var rv_applyTeam :RecyclerView = preView.findViewById<RecyclerView>(R.id.rv_applyTeam)
