...
class ResumeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cursor=sqlitedb.rawQuery("SELECT name, year, job FROM member WHERE id = '"+USER_ID+"';", null)
        if(cursor.moveToNext()){
        ...
        submitBtn.setOnClickListener {
            ...
            if(hopeET.text.toString()==""){
                ...
                sqlitedb.execSQL("INSERT INTO resume (s_id, t_num, r_hope, r_self_intro, r_etc) VALUES('"+USER_ID+"', "+t_num+", '"+str_hope+"', '"+str_self_intro+"', '"+str_etc+"')")
